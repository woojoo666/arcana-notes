...
let ParserRules = [
    ...
    {"name": "Statement", "symbols": ["Object"], "postprocess": (items) => ({type:'subList', items})},
    ...
    {"name": "Statement$ebnf$1$subexpression$1", "symbols": [{"literal":"else"}, "BracedBlock"]},
    ...
    {"name": "Statement", "symbols": [{"literal":"if"}, "Expression", {"literal":":"}, "BracedBlock", "Statement$ebnf$1"]},
